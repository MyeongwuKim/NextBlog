  ...
  return (
    <div className="w-full h-full flex-col">
      <div className="w-full flex justify-center items-center flex-col">
        ...
        >
          <div className="relative w-full  flex items-center flex-col max-w-[400px] px-4">
            ...
            <div className="w-full h-auto mb-4">
              <div className="relative flex flex-row items-center mb-2 w-full">
                ...
                <span className="font-semibold text-xl sm:text-base">이름</span>
              </div>
              <InputField
                id="name"
                height="46px"
          ...
          <div className="max-w-[400px] px-4 mt-4 mb-4 h-auto right-0 relative w-full flex flex-col justify-center items-center gap-4">
            <OkBtn
              type="submit"
              content="가입"
              width={"100%"}
